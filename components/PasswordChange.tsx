...
const PasswordChange: React.FC<PasswordChangeProps> = ({ onSuccess, onCancel, isForced = false }) => {
  ...
  const requirements = policy ? [
    { met: newPassword.length >= policy.minLength, text: `At least ${policy.minLength} characters` },
